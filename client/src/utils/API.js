...
export default {
    ...
    callSightseeing: function(query) {
        let url = "https://www.triposo.com/api/20200405/poi.json?location_id=" + location + "&tag_labels=sightseeing&bookable=1&fields=id,name,score,intro,booking_info&order_by=-score" + TP_ID + TP_TOKEN
    ...
    callTicketmaster: function(query) {
        let url = "https://app.ticketmaster.com/discovery/v2/events?classificationName=" + query + "&radius=" + distance + "&unit=miles&startDateTime=" + dateStart + "T00:00:00Z&endDateTime=" + dateEnd + "T00:00:00Z&city=" + city + TM_APIKEY
        console.log("Day Planner URL: " + url)
        return axios.get(url)
    },
