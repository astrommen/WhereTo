...
function OutdoorCard(props) {
  return(
    ...
    <Container>
      ...
      <Row>
        <Col size="md-5">
          <Image className="img-fluid" src={props.images ? props.images[0].URL : "./img/location/noImage.png"} alt={props.site} />
          <ImgDes>{props.images ? props.images[0].Description : ""}</ImgDes>
        </Col>
        <Col size="md-7">
          <Container>
            <Row>
